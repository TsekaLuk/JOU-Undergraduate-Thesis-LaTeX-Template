...
- `excellent-abstract-gallery.png`：校优摘要两页预览
...
- 校优摘要画廊：`templates/reports/excellent-thesis-abstract.pdf` 第 1 / 2 页
...
- 先运行 `latexmk -xelatex -bibtex templates/reports/excellent-thesis-abstract.tex` 或直接执行 `make readme-images`
