...
本目录收纳仓库中的补充文档，避免根目录散落过多 Markdown 文件。

## Guides

- [usage.md](guides/usage.md): 论文正文使用说明
- [table-examples.md](guides/table-examples.md): 表格示例
- [assets.md](guides/assets.md): 图片资源说明
- [screenshots.md](guides/screenshots.md): README 截图生成说明

## Overview

- [template-summary.md](overview/template-summary.md): 模板体系与能力概览
